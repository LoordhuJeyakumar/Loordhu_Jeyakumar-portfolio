...
function SideNavBar() {
  ...
  return (
    <div>
      <aside className={isActive ? "aside-open aside" : "aside"}>
        ...
        <div className="nav-wrapper">
          <nav className="navbar text-center align-items-center justify-content-center">
            <div className="collapse navbar-collapse show" id="navbarCollapse">
              <div className="about-avatar mb-5">
                <NavLink to={"/"}>
                  <img
                    src={profileImg}
                    alt=""
                    className="img-fluid mx-auto d-block shadow-sm rounded-full"
                  />
                </NavLink>

                <div className="about-avatar-details mt-3">
                  <p className="badge text-bg-warning">Loordhu Jeyakumar</p>
                </div>
              </div>

              <ul className="navbar-nav mx-auto w-100 " id="sidenav">
                <li className="nav-item">
                  <NavLink className={"nav-link ripple "} to="/home">
                    <span>About</span>
                    <i className="fa-solid fa-house-laptop"></i>
                  </NavLink>
                </li>
                <li className="nav-item">
                  <NavLink className="nav-link ripple" to="/skills">
                    <span>Skills</span>
                    <i className="fa-solid fa-code"></i>
                  </NavLink>
                </li>
                <li className="nav-item">
                  <NavLink className="nav-link ripple" to="/projects">
                    <span>Projects</span>
              ...
              <div>
                <button
                  className="btn btn-warning border-0 temeBtn"
                  onClick={
                    /* () => {
                    setIsDark((preveState) => {
                      return !preveState;
                    });
                  } */ toggleTheme
                  }
